...
import {
  StatisticDataForCard, Filters, CharactersFilter, LengthFilter,
              ...
              <div className="statistics-card">
                  ...
                  <div className="statistics-text">
                      <p>
                          ...
                          {' '}
                          <strong>{lettersPerWord.toFixed(1)}</strong>
                          {' '}
                          {t('statistics.inWord')}
                      </p>
                      ...
                      <p className="has-tooltip tooltip-relative">
                          ...
                          {timePerGame.hours > 0 && (
                          <>
                              <strong>{timePerGame.hours}</strong>
                              h
                          </>
                          )}
                          {' '}
                          ...
                          <>
                              <strong>{timePerGame.minutes}</strong>
                              m
                          </>
                          )}
                          {' '}
                          ...
                          <>
                              <strong>{timePerGame.seconds}</strong>
                              s
                          </>
                          )}
                          <span className="tooltip">
                  ...
                  <div className="statistics-other">
                      ...
                      <p className="has-tooltip has-tooltip-from-right tooltip-relative">
                          ...
                          {' '}
                          {t('statistics.totalBestStreak')}
                          <span className="tooltip">
                              {t('statistics.streakTooltipWithWorstStreak')}
                              {' '}
                              <strong>{worstStreak}</strong>
                          </span>
                      </p>
                      )}
                  </div>
